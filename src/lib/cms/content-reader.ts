...
export async function seedContentBlocks() {
  const seeds = [
    ...
    { key: "social-slogan", section: "homepage", title: "Konnect2Glory Slogan", content: "I REMAIN CONNECTED TO MY CHURCH FAMILY THROUGHOUT THE WEEK.", contentType: "text", status: "published" },
