...
export const metadata: Metadata = {
  title: "Events",
  description:
    "Browse upcoming and past church events at The Redeemed Christian Church of God, RCCG King of Glory, Utako, Abuja. Register for conferences, programmes, and community events.",
};
