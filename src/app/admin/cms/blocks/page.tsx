  ...
  return (
    <div className="max-w-6xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#28166F] mb-1">Content Blocks</h1>
          <p className="text-sm text-gray-500">Manage editable church content sections</p>
        </div>
        <Button asChild className="bg-[#28166F] hover:bg-[#0D0B1A]">
      ...
      {blocks.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-100 p-12 text-center">
          ...
          <Button asChild variant="outline" className="border-[#28166F] text-[#28166F]">
                ...
                <tr key={block.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right">
                    <Link
                      ...
                      className="text-xs font-medium text-[#28166F] hover:underline"
                    >
                      Edit
                    </Link>
                  </td>
