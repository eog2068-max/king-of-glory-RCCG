...
export const metadata: Metadata = {
  title: "Testimonies",
  description:
    "Read and share testimonies of God's faithfulness at The Redeemed Christian Church of God, RCCG King of Glory, Utako, Abuja. Be encouraged by real stories of healing, provision, and breakthrough.",
};
