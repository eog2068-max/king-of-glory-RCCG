...
export const metadata: Metadata = {
  title: "Live Stream",
  description:
    "Watch our services live online. The Redeemed Christian Church of God, RCCG King of Glory, Utako, Abuja — Sunday, Tuesday, and Thursday services streamed live.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
                <h3 className="text-sm font-bold text-[#28166F] mb-1">Streaming Tips</h3>
                <div className="space-y-3 text-xs text-gray-500 leading-relaxed">
                  <div className="flex items-start gap-2.5">
                    <div className="w-6 h-6 rounded-lg bg-[#E8E0F0] flex items-center justify-center shrink-0 mt-0.5">
                      <span className="text-[10px] font-bold text-[#28166F]">1</span>
                    </div>
                    <p>Use a stable WiFi or 4G/5G connection for the best streaming experience.</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-6 h-6 rounded-lg bg-[#E8E0F0] flex items-center justify-center shrink-0 mt-0.5">
                      <span className="text-[10px] font-bold text-[#28166F]">2</span>
                    </div>
                    <p>If the stream buffers, refresh the page or reduce other bandwidth usage.</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-6 h-6 rounded-lg bg-[#E8E0F0] flex items-center justify-center shrink-0 mt-0.5">
                      <span className="text-[10px] font-bold text-[#28166F]">3</span>
                    </div>
                    <p>Use the Share button to send the stream link to family and friends.</p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <div className="w-6 h-6 rounded-lg bg-[#E8E0F0] flex items-center justify-center shrink-0 mt-0.5">
                      <span className="text-[10px] font-bold text-[#28166F]">4</span>
                    </div>
