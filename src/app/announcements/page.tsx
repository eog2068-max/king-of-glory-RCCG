...
export const metadata: Metadata = {
  title: "Announcements",
  description:
    "Stay up to date with everything happening at The Redeemed Christian Church of God, RCCG King of Glory, Utako, Abuja. View church announcements, notices, and important updates.",
};
