...
export function GafLogin({ error, message }: GafLoginProps) {
  ...
  return (
    <section className="py-12 md:py-16 bg-[#E8E0F0] min-h-[60vh]">
      <div className="max-w-md mx-auto px-4 sm:px-6">
        <SectionWrapper>
          <Card className="border-0 shadow-xl">
            <CardHeader className="bg-gradient-to-br from-[#28166F] to-[#0D0B1A] text-white rounded-t-lg">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              {status === "sent" ? (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bold text-[#28166F] text-lg">Check your email</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium text-[#28166F]">
                      Email address
                    </label>
                    <Input
                      id="email"
              ...
              <div className="pt-4 border-t border-gray-100">
                <Link
                  href="/go-a-fishing"
                  className="inline-flex items-center gap-1.5 text-sm text-[#28166F] hover:underline"
                >
