...
export function GafAdminMembers() {
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
      <div>
        <h1 className="text-2xl lg:text-3xl font-bold text-[#28166F]">Members</h1>
            ...
            <ul className="divide-y divide-gray-100">
              {members.map((m) => (
                <li key={m.id} className="flex items-center gap-4 p-4 hover:bg-gray-50">
                  <div className="shrink-0 w-10 h-10 rounded-full bg-[#28166F]/10 flex items-center justify-center text-sm font-bold text-[#28166F]">
                    {m.fullName.charAt(0).toUpperCase()}
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <p className="font-medium text-[#28166F] truncate">{m.fullName}</p>
                      <span
