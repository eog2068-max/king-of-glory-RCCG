      ...
      {!loading && error && (
        <Card className="border-0 shadow-md border-red-200">
          <CardContent className="py-10 flex flex-col items-center gap-3 text-center">
            ...
            <Button onClick={() => fetchAnalytics(false)} className="bg-[#28166F] hover:bg-[#0D0B1A] text-white rounded-xl">
              Try again
            </Button>
          </CardContent>
        </Card>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-2xl font-bold text-[#28166F]">
                  ...
                  {data.funnel.map((item) => (
                    ...
                    >
                      ...
                      <span className="text-gray-600">
                        {item.label}: <strong className="text-[#28166F]">{item.count}</strong>
                    ...
                    {data.channelBreakdown.map((ch) => (
                      <div key={ch.channel}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-sm font-medium text-[#28166F]">
                    ...
                    <tbody>
                      {data.topPerformers.slice(0, 15).map((p, idx) => (
                        ...
                        >
                          ...
                          <td className="py-3">
                            <p className="font-medium text-[#28166F]">{p.fullName}</p>
                          ...
                          <td className="py-3 text-center">
                            <span className="font-bold text-[#28166F]">{Math.round(p.totalScore)}</span>
                          </td>
                          <td className="py-3 text-center">
                            <span
                              className={cn(
    ...
    >
      <Card className="border-0 shadow-md">
        <CardContent className="p-5">
          ...
          <div className="text-2xl font-bold text-[#28166F]">{value}</div>
