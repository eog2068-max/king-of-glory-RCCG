        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#28166F]/20 focus:border-[#28166F]"
            />
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="border-0 shadow-sm">
          <CardContent className="p-4 text-center">
            <div className="text-2xl font-bold text-[#28166F]">{total}</div>
          ...
          {loading && commendations.length === 0 ? (
            ...
            <div className="py-16 flex flex-col items-center gap-3 text-center">
              ...
              <Button
                onClick={() => setShowCreate(true)}
                variant="outline"
                className="gap-2 rounded-xl border-[#28166F]/20 text-[#28166F]"
              >
                <Plus className="size-4" />
                Issue the first one
              </Button>
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-start justify-between gap-2">
                              <div className="min-w-0">
                                <p className="font-semibold text-[#28166F] truncate">
                                  {c.title}
                                </p>
                                ...
                                <div className="flex flex-wrap items-center gap-2 mt-2">
                                  <span className="text-xs font-medium text-[#28166F]">
                                    {c.member.fullName}
                                  </span>
                                  ...
                                  {c.scriptureReference && (
                                    <>
                                      <span className="text-gray-300">|</span>
                                      <span className="text-xs text-[#DA251D] font-medium flex items-center gap-0.5">
                    ...
                    <div className="mt-1 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                      {memberResults.map((m) => (
                        ...
                        >
                          ...
                          <span className="font-medium text-[#28166F]">
                            {m.fullName}
                          </span>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-[#28166F]">Delete Commendation</h3>
