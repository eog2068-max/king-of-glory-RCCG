  ...
  if (submitted && selectedEvent) {
    return (
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-[#28166F] mb-2">Registration Successful!</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div>
                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  ...
                  Select Event <span className="text-[#DA251D]">*</span>
                </label>
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className={`text-sm font-bold leading-snug ${isSelected ? "text-[#28166F]" : "text-gray-800"}`}>
                              {event.title}
                            </p>
                ...
                {errors.event && <p className="text-xs text-[#DA251D] mt-1">{errors.event}</p>}
              </div>
              ...
              <div>
                ...
                />
                {errors.fullName && <p className="text-xs text-[#DA251D] mt-1">{errors.fullName}</p>}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className="rounded-xl border-gray-200 h-11 focus:border-[#28166F]/30"
                  />
                  {errors.email && <p className="text-xs text-[#DA251D] mt-1">{errors.email}</p>}
                </div>
                <div>
                  <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
                  ...
                  <Input
                    ...
                    className="rounded-xl border-gray-200 h-11 focus:border-[#28166F]/30"
                  />
                  {errors.phone && <p className="text-xs text-[#DA251D] mt-1">{errors.phone}</p>}
                </div>
              </div>
              ...
              <Button
                type="submit"
                disabled={submitting}
                className="w-full bg-[#DA251D] hover:bg-[#B91C1C] text-white rounded-xl h-12 text-base font-semibold"
              >
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {selectedEvent ? (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-28">
              <h3 className="text-sm font-bold text-[#28166F] mb-4">Event Details</h3>
              <div className="space-y-3 text-sm">
                ...
                <div className="pt-3 border-t border-gray-50 space-y-2.5">
                  <div className="flex items-start gap-2.5 text-xs">
                    <Calendar className="size-4 text-[#DA251D] shrink-0 mt-0.5" />
                    <div>
                  ...
                  <div className="flex items-start gap-2.5 text-xs">
                    <Clock className="size-4 text-[#DA251D] shrink-0 mt-0.5" />
                    <div>
                  ...
                  <div className="flex items-start gap-2.5 text-xs">
                    <MapPin className="size-4 text-[#DA251D] shrink-0 mt-0.5" />
                    <div>
                  ...
                  {selectedEvent.capacity && (
                    <div className="flex items-start gap-2.5 text-xs">
                      <Users className="size-4 text-[#DA251D] shrink-0 mt-0.5" />
                      <div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center sticky top-28">
              <div className="w-16 h-16 rounded-2xl bg-[#E8E0F0] flex items-center justify-center mx-auto mb-4">
                <Calendar className="size-7 text-[#28166F]/40" />
              </div>
          ...
          <div className="bg-[#F8FAFF] rounded-xl p-5">
            <h4 className="text-sm font-bold text-[#28166F] mb-2">Need Help?</h4>
            <p className="text-xs text-gray-500 leading-relaxed mb-3">
              If you have any questions about an event or need assistance with registration, please contact us.
            </p>
            <Button asChild variant="outline" size="sm" className="w-full border-[#28166F]/20 text-[#28166F] hover:bg-[#E8E0F0] rounded-lg text-xs">
