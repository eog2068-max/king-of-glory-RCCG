...
function getAvatarColor(name: string): string {
  const colors = [
    "from-[#28166F] to-[#3D2080]",
    "from-[#DA251D] to-[#E53935]",
    "from-[#2E7D32] to-[#388E3C]",
    "from-[#C62828] to-[#F57C00]",
    "from-[#3D2080] to-[#8E24AA]",
      ...
      <div className="h-screen bg-[#F8FAFF] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <Loader2 className="size-8 text-[#28166F] animate-spin mx-auto mb-3" />
      ...
      <div className="flex flex-1 min-h-0 max-w-5xl mx-auto w-full px-0 md:px-0 relative">
              ...
              <div className="p-4 border-b border-gray-100 bg-gradient-to-br from-[#F8FAFF] to-white">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#28166F] to-[#3D2080] flex items-center justify-center">
                      <MessageCircle className="size-4 text-white" />
                    </div>
                    <div>
                      <h2 className="text-sm font-bold text-[#28166F]">
                        FamilyChat
                      </h2>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 flex items-center gap-3 transition-all duration-150 ${
                      activeChannel?.id === ch.id
                        ? "bg-[#28166F]/5 border-l-[3px] border-[#28166F]"
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white">
          ...
          <div className="bg-white border-b border-gray-100 px-4 pt-6 pb-4 flex items-center justify-between shadow-sm shrink-0">
            ...
            >
              <span className="text-sm font-bold text-[#28166F] leading-tight">Chat Rooms</span>
              <ChevronLeft className="size-5 text-[#28166F] stroke-[2.5]" />
            </button>

            {/* Right: House icon + current channel name */}
            {activeChannel ? (
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-[#E8E0F0] to-[#E8EDFF] flex items-center justify-center">
                  <Home className="size-4 text-[#28166F]" />
                </div>
          ...
          >
            ...
            {activeChannel && messages.length === 0 && !activeChannel.isAnnouncement && (
              <div className="text-center py-16">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#E8E0F0] to-[#E8EDFF] flex items-center justify-center mx-auto mb-4">
                ...
                return (
                  <div key={msg.id} className="group relative py-0.5">
                    {msg.isAnnouncement ? (
                      ...
                      <div className="bg-gradient-to-r from-[#28166F]/[0.04] to-[#3D2080]/[0.04] border border-[#28166F]/10 rounded-xl p-3.5 my-1">
                        <div className="flex items-center gap-2 mb-1.5">
                          <div className="w-6 h-6 rounded-md bg-[#28166F]/10 flex items-center justify-center">
                            <Megaphone className="size-3 text-[#28166F]/70" />
                          </div>
                          <span className="text-[11px] font-bold text-[#28166F]">
                            {msg.displayName}
                          </span>
                      ...
                      <div className="flex gap-2.5">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {/* Reply reference */}
                          {msg.replyToId && (
                            <div className="mt-1 bg-[#E8E0F0] border-l-2 border-[#28166F]/25 rounded-r-lg px-2.5 py-1.5">
                              {msg.replyToDisplayName && (
                                <p className="text-[10px] font-semibold text-[#28166F]/60">
                                  {msg.replyToDisplayName}
                                </p>
                              )}
                          ...
                          <div className="flex items-center gap-0.5 mt-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button
                              ...
                              className="p-1 hover:bg-gray-100 rounded-md text-gray-400 hover:text-[#28166F] transition-colors"
                              title="Reply"
                            >
            ...
            <div className="bg-white border-t border-gray-100 p-3 pb-16 shrink-0">
              ...
              <AnimatePresence>
                {replyingTo && (
                  ...
                  >
                    <div className="flex items-center gap-2 bg-[#E8E0F0] border border-[#28166F]/10 rounded-lg px-3 py-2 mb-2">
                      <Reply className="size-3 text-[#28166F] shrink-0" />
                      <div className="min-w-0 flex-1">
                        <p className="text-[10px] font-semibold text-[#28166F]/60">
              ...
              <div className="flex items-end gap-2">
                <div className="flex-1 relative">
                  <textarea
                    ...
                    rows={1}
                    className="w-full resize-none rounded-xl border border-gray-200 bg-[#FAFBFF] px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#28166F]/15 focus:border-[#28166F]/25 transition-all min-h-[42px] max-h-24 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                  ...
                  className="shrink-0 w-10 h-[42px] rounded-xl bg-[#28166F] hover:bg-[#3D2080] text-white flex items-center justify-center transition-colors disabled:opacity-30 disabled:cursor-not-allowed shadow-sm"
                >
                  {sending ? (
                ...
                <div className="space-y-1.5 max-h-48 overflow-y-auto">
                  {REPORT_REASONS.map((r) => (
                    ...
                    >
                      ...
                      >
                        {reportReason === r.value && (
                          <div className="w-2 h-2 rounded-full bg-[#28166F]" />
                        )}
                      </div>
              ...
              {reportReason && (
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-[#28166F]/15 focus:border-[#28166F]/25 transition-colors"
                  />
                </div>
              )}
...
function MessageReactions({
  ...
  return (
    <div className="flex items-center gap-1 mt-1 flex-wrap">
      ...
      >
        <SmilePlus
          className={`size-3 transition-colors ${showPicker ? "text-[#28166F]" : "text-gray-400"}`}
        />
      </button>
