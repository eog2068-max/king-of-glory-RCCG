      ...
      <div className="max-w-4xl mx-auto px-4 pt-28 pb-24">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-[#28166F]">Live Together</h1>
          </div>
        ...
        {session?.status === "live" ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
            ...
            <h2 className="text-xl font-bold text-[#28166F] mb-2">Not Live Right Now</h2>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              <div className="bg-purple-50 rounded-xl px-4 py-3">
                <p className="text-sm font-bold text-[#28166F]">Sunday</p>
              ...
              <div className="bg-red-50 rounded-xl px-4 py-3">
                <p className="text-sm font-bold text-[#DA251D]">Thursday</p>
                <p className="text-xs text-gray-500">5:30 PM</p>
              </div>
            </div>
          </motion.div>
