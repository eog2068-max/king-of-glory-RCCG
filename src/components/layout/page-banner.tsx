...
export function PageBanner({
  ...
  return (
    ...
    >
      {/* Background */}
      <div
        className="absolute inset-0 bg-gradient-to-br from-[#0D0B1A] via-[#28166F] to-[#28166F]"
      />
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#DA251D] rounded-full blur-[128px] -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#3D2080] rounded-full blur-[128px] translate-y-1/2 -translate-x-1/3" />
      </div>
      {overlay && (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="h-1 bg-[#DA251D] rounded-full mt-6"
        />
      </div>
    </section>
  );
