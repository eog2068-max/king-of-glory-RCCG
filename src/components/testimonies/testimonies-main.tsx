      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SectionWrapper>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            <div className="bg-white rounded-xl border border-gray-100 p-5 text-center">
              <div className="w-10 h-10 rounded-xl bg-[#E8E0F0] flex items-center justify-center mx-auto mb-3">
                <Heart className="size-5 text-[#28166F]" />
              </div>
              <p className="text-2xl font-bold text-[#28166F]">
                {stats.total}
              </p>
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5 text-center">
              <div className="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center mx-auto mb-3">
                <TrendingUp className="size-5 text-[#DA251D]" />
              </div>
        ...
        <SectionWrapper>
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-[#28166F]">
              Browse Testimonies
            </h3>
            <Button
              onClick={scrollToForm}
              className="bg-[#DA251D] hover:bg-[#B91C1C] text-white rounded-xl h-9 px-4 text-sm font-semibold"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="h-10 rounded-xl border border-gray-200 bg-white px-3 text-sm text-gray-600 focus:outline-none focus:border-[#28166F]/30 cursor-pointer"
              >
          ...
          {hasActiveFilters && (
            <button
              onClick={clearAll}
              className="text-xs text-[#DA251D] hover:text-[#B91C1C] mt-2 mb-2"
            >
              Clear all filters
            </button>
          )}
        ...
        <SectionWrapper>
          <div className="bg-gradient-to-br from-[#EBF0FA] to-[#E8E0F0] rounded-2xl p-8 md:p-12 text-center my-12">
            <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center mx-auto mb-5">
              <BookOpen className="size-7 text-[#28166F]" />
            </div>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-lg md:text-xl font-semibold text-[#28166F] leading-relaxed mb-3 italic max-w-2xl mx-auto">
