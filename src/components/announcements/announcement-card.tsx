...
export function AnnouncementCard({
  ...
  if (variant === "featured") {
    return (
      ...
      >
        <div className="h-1.5 bg-gradient-to-r from-[#28166F] via-[#3D2080] to-[#9C27B0]" />
        <div className="flex flex-col md:flex-row">
          <div className="flex-1 p-6 md:p-8">
            <div className="flex flex-wrap items-center gap-2 mb-3">
              {a.isPinned && (
                <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-[#DA251D] bg-red-50 px-2 py-0.5 rounded-md uppercase tracking-wider">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-[#28166F] mb-3 leading-snug">
              {a.title}
            </h3>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            {a.isPinned && <Pin className="size-3 text-[#DA251D] shrink-0" />}
