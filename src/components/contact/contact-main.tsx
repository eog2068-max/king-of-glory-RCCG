          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <motion.div variants={itemVariants}>
              <div className="relative rounded-2xl overflow-hidden border border-gray-100 shadow-sm h-64 md:h-80">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#0D0B1A] via-[#28166F] to-[#1B2656]" />
                ...
                <div className="absolute top-1/4 right-1/4 w-48 h-48 bg-[#3D2080] rounded-full blur-[80px] opacity-30" />
                <div className="absolute bottom-1/4 left-1/3 w-40 h-40 bg-[#DA251D] rounded-full blur-[80px] opacity-10" />
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center px-6">
                  ...
                  >
                    <div className="relative">
                      <div className="absolute -inset-3 bg-[#DA251D]/20 rounded-full blur-md" />
                      <div className="relative w-14 h-14 rounded-full bg-[#DA251D] flex items-center justify-center shadow-lg shadow-[#DA251D]/30">
                  ...
                  >
                    <Button
                      asChild
                      className="bg-white text-[#28166F] hover:bg-gray-100 rounded-xl px-6 font-semibold shadow-lg text-sm"
                    >
                      <a
                        href={churchInfo.mapsUrl}
                        target="_blank"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-sm font-medium text-gray-700 mt-0.5 group-hover:text-[#28166F] transition-colors leading-snug">
                        {card.value}
                      </p>
                    </div>
                    {card.external && (
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-[#E8E0F0] flex items-center justify-center text-[#28166F] hover:bg-[#28166F] hover:text-white transition-all hover:shadow-md hover:shadow-[#28166F]/20"
                    >
