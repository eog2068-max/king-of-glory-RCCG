    ...
    <section className="py-12 md:py-16 bg-[#F8FAFF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionWrapper>
          <SectionTitle
            title="Video Gallery"
            subtitle="Watch powerful sermons, inspiring messages, and complete service recordings from RCCG King of Glory"
          />
        </SectionWrapper>
        ...
        {selectedSeries && (
          <div className="mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-[#28166F]">{selectedSeries.name}</h2>
        ...
        <p className="text-sm text-gray-500 mb-6">
          <span className="font-semibold text-[#28166F]">{filteredVideos.length}</span> video{filteredVideos.length !== 1 ? "s" : ""}
          {selectedSeries && (
