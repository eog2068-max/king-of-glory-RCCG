...
export const mockSeries: Series[] = [
  { id: "s1", name: "Walking in Destiny", description: "A powerful series on discovering and fulfilling your God-given destiny", videoCount: 6, coverGradient: "from-[#28166F] to-[#3D2080]" },
  { id: "s2", name: "Prayer That Moves Mountains", description: "Learning the secrets of effectual and fervent prayer", videoCount: 4, coverGradient: "from-[#DA251D] to-[#B91C1C]" },
  ...
  { id: "s4", name: "Family Matters", description: "Building godly homes and strong family foundations", videoCount: 4, coverGradient: "from-[#C62828] to-[#B91C1C]" },
  { id: "s5", name: "Spiritual Warfare", description: "Equipping believers for victory in spiritual battles", videoCount: 3, coverGradient: "from-[#28166F] to-[#311B92]" },
  { id: "s6", name: "Sunday Services", description: "Complete Sunday worship service recordings", videoCount: 12, coverGradient: "from-[#0D0B1A] to-[#28166F]" },
];
