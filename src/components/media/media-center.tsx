      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionWrapper>
          ...
          <Tabs defaultValue={tab} className="w-full">
            <TabsList className="bg-[#E8E0F0] p-1.5 rounded-xl mx-auto w-fit flex-wrap gap-1 mb-10">
              {tabItems.map((item) => (
                <TabsTrigger
                  key={item.value}
                  value={item.value}
                  className="rounded-lg px-4 py-2.5 text-sm font-medium data-[state=active]:bg-white data-[state=active]:text-[#28166F] data-[state=active]:shadow-sm gap-2"
                >
