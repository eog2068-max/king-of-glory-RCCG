        ...
        {filtered.map((photo, i) => (
          ...
          >
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#E8EDFF] to-[#E8E0F0] shadow-sm hover:shadow-lg transition-all duration-300">
              ...
              >
                <Camera className="size-10 text-[#28166F]/10" />
              </div>
              ...
              {/* Category tag */}
              <span className="absolute top-3 left-3 bg-white/90 text-[#28166F] text-[10px] px-2 py-0.5 rounded-md font-medium">
                {photo.category}
              </span>
            </div>
          </motion.div>
      ...
      <AnimatePresence>
        {selectedPhoto && (
          ...
          >
            ...
            >
              <div className="bg-gradient-to-br from-[#E8EDFF] to-[#E8E0F0] rounded-2xl aspect-video flex items-center justify-center relative">
                <Camera className="size-16 text-[#28166F]/15" />
                <span className="absolute text-sm text-[#28166F]/30 font-medium">Photo</span>
              </div>
