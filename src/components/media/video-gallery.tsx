        ...
        {filtered.map((video, i) => (
          ...
          >
            ...
            <div className="relative aspect-video bg-gradient-to-br from-[#0D0B1A] to-[#3D2080] overflow-hidden">
              ...
              {/* Category tag */}
              <span className="absolute top-2 left-2 bg-[#28166F]/80 text-white text-[10px] px-2 py-0.5 rounded-md font-medium">
                {video.category}
              </span>
              {/* Hover overlay */}
            ...
            {/* Info */}
            <div className="p-4">
              <h3 className="text-sm font-bold text-[#28166F] leading-tight line-clamp-2 mb-2">
                {video.title}
              </h3>
        ...
        {selectedVideo && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-[#0D0B1A] rounded-2xl overflow-hidden w-full max-w-4xl shadow-2xl"
            >
              {/* Player area */}
              ...
              <div className="p-5 bg-white">
                <h3 className="text-lg font-bold text-[#28166F]">{selectedVideo.title}</h3>
