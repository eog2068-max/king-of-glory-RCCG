  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-lg font-bold text-[#28166F]">Recent Service Replays</h3>
        <Link
          href="/videos"
          className="text-sm text-[#28166F] hover:text-[#0D0B1A] font-medium transition-colors"
        >
          View All Videos
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {pastStreams.map((stream, i) => (
          ...
          >
            {/* Thumbnail */}
            <div className="relative aspect-video bg-gradient-to-br from-[#0D0B1A] to-[#28166F] flex items-center justify-center">
            ...
            {/* Content */}
            <div className="p-4">
              <h4 className="text-sm font-bold text-gray-800 mb-2 line-clamp-2 group-hover:text-[#28166F] transition-colors leading-snug">
                {stream.title}
              </h4>
