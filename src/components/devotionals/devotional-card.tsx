...
export function DevotionalCard({
  ...
  if (variant === "compact") {
    return (
      ...
      >
        <div className="w-10 h-10 rounded-lg bg-[#E8E0F0] flex flex-col items-center justify-center shrink-0">
          <span className="text-sm font-bold text-[#28166F] leading-none">
            {dateObj.getDate()}
          </span>
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-gray-800 truncate group-hover:text-[#28166F] transition-colors">
            {devotional.title}
          </p>
  ...
  if (variant === "featured") {
    return (
      <motion.div
        ...
        onClick={() => onClick?.(devotional)}
      >
        <div className="h-2 bg-gradient-to-r from-[#28166F] to-[#3D2080]" />
        <div className="p-6 md:p-8">
          ...
          <h3 className="text-xl md:text-2xl font-bold text-[#28166F] mb-2 group-hover:text-[#3D2080] transition-colors">
            {devotional.title}
          </h3>

          <div className="flex items-center gap-2 mb-4 text-sm text-[#DA251D] font-medium">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-50">
            ...
            <span className="text-sm font-semibold text-[#28166F] flex items-center gap-1 group-hover:gap-2 transition-all">
              Read More
  ...
  return (
    <motion.div
      ...
      onClick={() => onClick?.(devotional)}
    >
      <div className="h-1.5 bg-gradient-to-r from-[#28166F] to-[#3D2080]" />
      <div className="p-5">
        <div className="flex items-center gap-2 mb-3">
          <Badge
            className={`${cat.bg} ${cat.text} border-0 text-[10px] font-semibold uppercase tracking-wider`}
        ...
        <div className="flex items-center gap-1.5 mb-3 text-xs text-[#DA251D] font-medium">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-50">
          ...
          <span className="text-xs font-semibold text-[#28166F] flex items-center gap-1 group-hover:gap-1.5 transition-all">
            Read More
