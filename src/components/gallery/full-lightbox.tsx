        ...
        <div className="flex-1 flex relative overflow-hidden">
          ...
          >
            <AnimatePresence mode="wait">
              ...
              >
                <Camera className="size-20 text-[#28166F]/15" />
                  ...
                  <div className="grid grid-cols-3 gap-1.5">
                    {photos.map((p, i) => (
                      <button
                        ...
                        className={`aspect-square rounded-lg bg-gradient-to-br from-[#E8EDFF] to-[#E8E0F0] flex items-center justify-center transition-all ${
                          i === current
                            ? "ring-2 ring-white/50 scale-95"
                            : "opacity-60 hover:opacity-100"
                        }`}
                      >
                        {i === current && <Camera className="size-4 text-[#28166F]/30" />}
                      </button>
                    ))}
                  </div>
                </div>
