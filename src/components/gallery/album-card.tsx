  ...
  return (
    ...
    >
      <div className="relative rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
        {/* Cover image area */}
        <div className="relative aspect-[4/3] bg-gradient-to-br from-[#E8EDFF] via-[#E8E0F0] to-[#EBF0FA] overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <Camera className="size-12 text-[#28166F]/10" />
          </div>

          {/* Category tag */}
          <span className="absolute top-3 left-3 bg-white/90 text-[#28166F] text-[11px] px-2.5 py-1 rounded-lg font-semibold backdrop-blur-sm">
            {album.category}
          </span>

          {/* Photo count badge */}
          <span className="absolute top-3 right-3 bg-[#28166F]/90 text-white text-[11px] px-2.5 py-1 rounded-lg font-semibold backdrop-blur-sm">
        ...
        {/* Info */}
        <div className="p-5">
          <h3 className="text-base font-bold text-[#28166F] leading-tight group-hover:text-[#0D0B1A] transition-colors">
            {album.name}
          </h3>
