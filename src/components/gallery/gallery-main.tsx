    ...
    <section className="py-16 md:py-20 bg-[#F8FAFF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionWrapper>
          <SectionTitle
            title="Photo Gallery"
            subtitle="Relive the beautiful moments and memories from our services, events, and community life at RCCG King of Glory"
          />
        </SectionWrapper>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between mb-8">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                ...
                className="pl-10 rounded-xl border-gray-200 bg-white h-11 focus:border-[#28166F]/30"
              />
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 h-11 rounded-xl border border-gray-200 bg-white text-sm text-gray-700 appearance-none cursor-pointer focus:outline-none focus:border-[#28166F]/30 focus:ring-2 focus:ring-[#28166F]/10"
                >
          ...
          {selectedAlbum && (
            ...
            >
              <button
                ...
                className="inline-flex items-center gap-2 text-sm text-[#28166F] hover:text-[#0D0B1A] font-medium transition-colors"
              >
                <ArrowLeft className="size-4" />
                Back to Albums
              </button>
              <h2 className="text-2xl md:text-3xl font-bold text-[#28166F] mt-2">
                {selectedAlbum.name}
              </h2>
        ...
        {!selectedAlbum && viewMode === "all" && (
          <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 space-y-4">
            {filteredPhotos.map((photo, i) => (
              ...
              >
                <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#E8EDFF] to-[#E8E0F0] shadow-sm hover:shadow-lg transition-all duration-300">
                  <div
                  ...
                  >
                    <Camera className="size-8 text-[#28166F]/10" />
                  </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
            {albumPhotos.map((photo, i) => (
              <motion.div
                ...
                className="group cursor-pointer aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-[#E8EDFF] to-[#E8E0F0] relative"
              >
                <Camera className="size-6 text-[#28166F]/10 absolute inset-0 m-auto" />
