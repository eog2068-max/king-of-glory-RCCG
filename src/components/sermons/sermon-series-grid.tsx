      ...
      {series.map((s, i) => (
        ...
        >
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md hover:border-gray-200 transition-all duration-300">
            ...
            {/* Content */}
            <div className="p-5">
              <h3 className="text-base font-bold text-[#28166F] mb-1.5 group-hover:text-[#0D0B1A] transition-colors leading-snug">
                {s.name}
              </h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <ChevronRight className="size-4 text-gray-300 group-hover:text-[#28166F] group-hover:translate-x-0.5 transition-all" />
              </div>
            </div>
          </div>
        </motion.div>
