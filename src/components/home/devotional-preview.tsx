  ...
  return (
    <SectionWrapper className="bg-gradient-to-b from-[#EBF0FA] to-white py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-black/5 p-6 md:p-8 border border-[#28166F]/5">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            <BookOpen className="size-4 text-[#28166F]" />
            <span>{today}</span>
          </div>

          <h3 className="text-xl md:text-2xl font-bold text-[#28166F] mb-4">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <Button
              asChild
              variant="outline"
              className="rounded-xl border-[#28166F]/20 text-[#28166F] hover:bg-[#EBF0FA]"
            >
            ...
            <div className="mt-3">
              <Link href="/devotionals" className="text-xs text-gray-400 hover:text-[#28166F] transition-colors">
