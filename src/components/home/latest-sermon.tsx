      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-black/5 overflow-hidden border border-gray-100">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="relative md:w-80 aspect-video md:aspect-auto bg-gradient-to-br from-[#28166F] to-[#3D2080] flex items-center justify-center shrink-0">
            ...
            <div className="p-6 md:p-8 flex flex-col justify-center">
              <h3 className="text-xl md:text-2xl font-bold text-[#28166F] mb-2">
                The Power of Faith
              </h3>
              ...
              <div>
                <Button
                  asChild
                  className="bg-[#DA251D] hover:bg-[#B91C1C] text-white rounded-xl px-6"
                >
                  <Link href="/sermons">
              ...
              <div className="mt-3">
                <Link href="/sermons" className="text-xs text-gray-400 hover:text-[#28166F] transition-colors">
